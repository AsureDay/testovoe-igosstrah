...
def main():
    ...
    data = load_data(
        "/home/uwi/my_workspace/2026/testovoe_ingosstrah/agent_validation/validation_results.json"
    )
    metrics = calculate_metrics(data)
    create_visualization(
        metrics,
        "/home/uwi/my_workspace/2026/testovoe_ingosstrah/agent_validation/validation_chart.png",
    )
